...
// Locates the index of an element in the list based on a callback function.
// If the equals function returns 1, the index of that element matches and gets returned
// If no element in the list matches, -1 is returned

void* list_find(list_t* list, int (*equals)(void* element));
// Locates an element in the list based on a callback function.
// If the equals function returns 1, that element matches and gets returned
// If no element in the list matches, NULL is returned
